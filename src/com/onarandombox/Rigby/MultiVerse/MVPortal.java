...
public class MVPortal {
    ...
    private void setupLocation() {
        String[] v = this.config.getString("portals." + name + ".location", "0,0,0:0,0,0").split(":");
    ...
    public void save() {
        this.config.setProperty("portals." + this.name + ".world", this.world.getName());
        this.config.setProperty("portals." + this.name + ".location", this.min + ":" + this.max);
        ...
        if (this.destLocation != null) {
            this.config.setProperty("portals." + this.name + ".destlocation", this.destLocation);
        } else {
            this.config.setProperty("portals." + this.name + ".destlocation", null);
        }
